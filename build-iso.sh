...
for file in setup.py engine.py locales.py desktop.py desktop-first-login.py update-desktop.py winux_profile.py winux_core.py winux-session.sh control-panel.cpp wallpaper.hpp WINUX-DESKTOP.md DESKTOP.md wallpaper.jpg user.bmp hardware.py bootloader.py repair-boot.py BOOT-REPAIR.md network.py welcome.py launch.sh xsession.sh arch-win7-aero-postinstall.sh README.md TUTORIAL.md POSTINSTALL.md; do
