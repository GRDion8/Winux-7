...
for file in setup.py engine.py hardware.py bootloader.py repair-boot.py BOOT-REPAIR.md network.py welcome.py launch.sh xsession.sh arch-win7-aero-postinstall.sh README.md TUTORIAL.md POSTINSTALL.md; do
